...
trait Kama_Thumbnail__Admin {
	...
	function _options_field(){
		...
		$elems = [
			...
			'quality' =>
				'<code>quality</code> <input type="number" name="'. $opt_name .'[quality]" value="'. $opt->quality .'" style="width:60px;">
			...
			'use_in_content' => '
				...
				<p class="description" style="display:inline-block;">'. sprintf( __('Find specified here class of IMG tag in content and make thumb from found image by it sizes. Leave this field empty to disable this function. Default: %s','kama-thumbnail'), '<code>mini</code>' ) .'</p>',
